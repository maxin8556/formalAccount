...
from core.SimulationProcess.specificProcess import Tumblr

LoggerSingleton().init_dict_config(LOGGING_CONFIG)


class TumblrSpiderTest(object):

    def __init__(self):
        self._logger = logging.getLogger()
        # 网站主页,注入cookie时用的
        self.home_url = "https://www.tumblr.com"
        # 登录Url
        self.loginUrl = "https://www.tumblr.com/login"
        # 发帖的URL
        self.post_url = "https://www.tumblr.com/new/text?"

        self.webSource = "tumblr"
        # self.userName = "maxin8556@163.com"
        # self.passWord = "xXx+_r3Q6"
        self.userName = "evandean83612@gmail.com"
        self.passWord = "BbLove123@"
        # 个人主页 https://www.tumblr.com/blog/beatabecky
        self._browser = Tumblr()  # 浏览器
        self.account_info = {}
    ...
    def spider_basic_state(self, path, login_url):
        ...
        try:
            # 判断用户是否在线
            # 该元素是判断用户是否在线的元素
            is_on_element = TumblrElement.is_on_element
            ...
            if state_account == BrowserState.TYPE_ONLINE:  # 在线
                ...
                # 离线状态，登陆账号
                username_element = TumblrElement.username_element
                password_element = TumblrElement.password_element
                login_element = TumblrElement.login_element
...
if __name__ == '__main__':
    t1 = time.time()
    spider = TumblrSpiderTest()
    path = r"D:\MaXin-Study\2021-10-3\FinalVersionAccountForum\cookieData\cookietumblr\cookies-evandean83612@gmail.com.json"
    # path = ""
    account_info = ""
