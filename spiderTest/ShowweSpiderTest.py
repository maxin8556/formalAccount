...
import random
import logging
from core.SimulationProcess.specificProcess import Showwe
from Utils.CookieOperation import getCookie
from core.elementLocation import ShowweElement
...
class ShowweSpiderTest(object):

    def __init__(self):
        self._logger = logging.getLogger()

        # 网站主页,注入cookie时用的
        self.home_url = "https://showwe.tw"
        # 登录Url
        self.loginUrl = "https://showwe.tw/login.aspx"
        # 发帖的URL
        self.post_url = "https://showwe.tw/mbr/postedit.aspx"
        # self.userName = "maxin8556@163.com"
        # self.passWord = "Maxin123@"
        self.webSource = "showwe"
        self.userName = "nialladams931@gmail.com"
        self.passWord = "bblove123"

        self._browser = Showwe()  # 浏览器
        self.account_info = {}
    ...
    def spider_basic_state(self, path, login_url):
        ...
        try:
            # 判断用户是否在线
            is_on_element = ShowweElement.is_on_element
            ...
            if state_account == BrowserState.TYPE_ONLINE:  # 在线
                ...
                # 离线状态，登陆账号
                username_element = ShowweElement.username_element
                password_element = ShowweElement.password_element
                login_element = ShowweElement.login_element
...
if __name__ == '__main__':
    t1 = time.time()
    spider = ShowweSpiderTest()
    # path = r"../cookieData/cookieshowwe/cookies-maxin8556@163.com.json"
